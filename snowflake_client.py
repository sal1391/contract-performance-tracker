...
FIELD_DICTIONARY = {
    # Metrics
    "VOLUME": "Total fuel tons delivered. SQL: SUM(VOLUME_TONS).",
...
def get_all_company_names(session):
    """Return distinct CUSTOMER_NAME values from the sales planning view."""
    sql = f"""
...
def fetch_all_snowflake_data(session, company_name):
    """
    Consolidated sales planning data for the agents.
